...
All companion types in Warframe including Kubrows, Kavats, MOAs, Hounds, and Sentinels. Includes base stats, crafting requirements, and descriptions.
...
| Blueprint | 1 |
| Pustulite | 15 |
| Spinal Core Section | 8 |
| Tubercular Gill System | 20 |
| Vome Residue | 6 |
...
| Component | Count |
|---|---|
| Benign Infested Tumor | 30 |
| Blueprint | 1 |
| Dendrite Blastoma | 15 |
| Fass Residue | 6 |
| Ganglion | 15 |
...
| Blueprint | 1 |
| Gallium | 5 |
| Sapcaddy Venedo Case | 10 |
| Spectral Debris | 5 |
| Trapezium Xenorhast | 2 |
...
It may also be a reference to the shape of their ears resembling a Pharaoh's headdress, called a Nemes.
Health: 710 | Shield: 350 | Armor: 300 | Energy: 100
...
|---|---|
| Blueprint | 1 |
| Echowinder Anoscopic Sensor | 15 |
| Smooth Phasmin | 20 |
| Tepa Nodule | 15 |
| Travocyte Alloy | 40 |
...
|---|---|
| Blueprint | 1 |
| Echowinder Anoscopic Sensor | 10 |
| Heart Noctrul | 5 |
| Plastids | 1000 |
| Thermal Sludge | 20 |
...
## Venari
Khora's loyal Kavat. Her constant companion and protector.
Health: 900 | Shield: 0 | Armor: 350 | Energy: 100

## Venari Prime
Khora's will, Venari's fangs and claws.
Health: 1050 | Shield: 0 | Armor: 450 | Energy: 100
...
Health: 650 | Shield: 300 | Armor: 150 | Energy: 100
...
**Tips:**
Adding zoom to the Deth Machine Rifle such as Eagle Eye will increase the lock-on range for the Dethcube, while Speed Trigger will increase the fire rate. Regen will increase overall survivability of the sentinel in combat.
**Trivia:**
...
Dethcube and Shade were available as promotional items within the virtual world of PlayStation Home, following the users Avatar as they move.
Health: 560 | Shield: 250 | Armor: 80 | Energy: 100
...
Comparisons
Dethcube Prime, compared to Dethcube:
Higher Health (600 vs. 560)
Higher Shield (300 vs. 250)
Higher Armor (150 vs. 80)
...
Calculated Shot cannot be simultaneously equipped with Assault Mode.
Electro Pulse links to a target and delivers a constant Electricity proc to the target, which will link to nearby targets but will not stun those additional enemies. It deals very little damage, and enemies will be able to use abilities or fire their weapon a little between their stun animations. This makes it useful for enemies that rush the player, stunning one in place until the enemy is killed or the player moves out of range.
Health: 700 | Shield: 150 | Armor: 80 | Energy: 100
...
List of Sentinel Mods
Precept Mod Notes
Whether this Sentinel's unique precept mods are equipped or not, and the order in which they are equipped, will affect its behaviour:
Helios will only attack targets if Targeting Receptor is equipped in one of its first two Penjaga slots, while Assault Mode will function in any slot.
As of November 2020, with Targeting Receptor the Deconstructor will fire in 3-round bursts, followed by a ~6 second cooldown. If the current target dies early the Deconstructor will not fire the rest of its burst at anything else, and will enter the long cooldown. This is inferior to Assault Mode, which will have the Deconstructor fire at full rate for its full 6 round clip at a much farther range. This extensive delay on switching targets happens with every weapon type.
...
Vaultings
On December 7th, 2018, it was announced that Helios Prime would enter the Prime Vault and be retired from the reward tables on December 18th, 2018. Any preexisting components or fully-built sentinels will remain as-is.
...
**Tips:**
Oxylus can be useful for finding fishing hotspots with less effort, rather than searching for the bubbles/glow that signifies their presence.
It can also be useful identifying objects such as Ayatan Treasures, as they are marked in the loot radar but cannot be broken by Oxylus.
Equipped with the Scan Aquatic Lifeforms precept mod, Oxylus can show the user the location of fish, negating the use of Luminous Dye. However, only the player with Oxylus can benefit from the illumination.
**Trivia:**
Oxylus refers to multiple people in Greek mythology:
...
Having Assault Mode equipped will increase Shade's attack range, but not change its inherent behaviour to only attack after its owner has been attacked.
...
Health: 600 | Shield: 130 | Armor: 80 | Energy: 100
...
Higher Health (700 vs. 600)
Higher Shield (300 vs. 130)
Higher Armor (100 vs. 80)
Has an additional Penjaga and Naramon polarities.
...
The minigame Wyrmius features Wyrm.
Health: 560 | Shield: 250 | Armor: 80 | Energy: 100
...
Wyrm Prime – along with Sicarus Prime, Ember Prime, Frost Prime, Latron Prime, Reaper Prime, Loki Prime, Bo Prime, and Glaive Prime – were available from Cetus Bounties from February 6, 2018 to April 10, 2018.
Wyrm Prime, along with Loki Prime, Bo Prime, Volt Prime, and Odonata Prime, were available from April 30th to July 2nd, 2019.
Comparisons
