# Arch-Melee Weapons
All Archwing-mounted melee weapons. Includes damage types, critical stats, status chance, and crafting info.
...
Tenno
Tear apart incoming enemies with this massive hooked blade.
The Agkuza is an Archmelee hook-sword released in Update Specters of the Rail.
}
|}
Characteristics
...
Jm7yXPXMN8E
**Type:** Arch-Melee | **Mastery Req:** 3 | **Riven Disposition:** 1

### Normal Attack
**Damage:** impact: 65.4, slash: 65.4, puncture: 305.2
Crit Chance: 5.00% | Crit Multiplier: 1.5x | Status Chance: 15.00% | Fire Rate: 1

### Crafting
| Component | Count | Drops |
|---|---|---|
| Blade | 1 | New Loka, Benevolent (100.00%) |
| Blueprint | 1 | — |
| Guard | 1 | Steel Meridian, Defender (100.00%) |
| Handle | 1 | Red Veil, Esteemed (100.00%) |
...
Weapons
Part sword, part shield, the Centaur excels at charging headlong into enemy fire.
The Centaur is an Archmelee with a powerful six-hit combo complimented by its high attack speed and high critical chance to supplement its low damage.
}E
|}
Characteristics
...
**Trivia:**
thumb|300px|The Centaur Leak during Update 15.6.1.
A Centaur is a mythological creature that is half-human, half-horse.
...
The Centaur (along with the Fluctus and the Itzal) was accidentally leaked in Update 15.6.1, where a bundle called the "Itzal Raider Pack" visually replaced the Stealth Pack in the Market. The Stealth Bundle still functioned as normal however.
ctqbi9mCFg0
**Type:** Arch-Melee | **Mastery Req:** 8 | **Riven Disposition:** 1

### Normal Attack
**Damage:** impact: 37.6, slash: 263.2, puncture: 75.2
Crit Chance: 25.00% | Crit Multiplier: 2x | Status Chance: 20.00% | Fire Rate: 1.08

### Crafting
| Component | Count | Drops |
|---|---|---|
| Aegis | 1 | Arbiters of Hexis, Lawful (100.00%) |
| Blade | 1 | The Perrin Sequence, Executive (100.00%) |
| Blueprint | 1 | — |
| Handle | 1 | New Loka, Benevolent (100.00%) |
...
Archwing
Become an angel of death, with this Archwing scythe.
The Kaszas is an Archmelee scythe released as a part of Update 17.5: The Jordas Precept.
Characteristics
This weapon deals primarily Puncture damage.
Innate Vazarin polarity.
**Trivia:**
...
**Type:** Arch-Melee | **Mastery Req:** 4 | **Riven Disposition:** 1

### Normal Attack
**Damage:** impact: 19.7, slash: 58.7, puncture: 313.6
Crit Chance: 15.00% | Crit Multiplier: 2x | Status Chance: 20.00% | Fire Rate: 1

### Crafting
| Component | Count | Drops |
|---|---|---|
| Blade | 1 | Red Veil, Honored (100.00%) |
| Blueprint | 1 | — |
| Handle | 1 | Steel Meridian, Valiant (100.00%) |
| Tellurium | 3 | — |
...
Weapons
Gallium-alloy gauntlets for close-range Archwing combat. Designed by the infamous Tyl Regor.
The Knux are large Archmelee gauntlets based on Tyl Regor's fist weapons.
Characteristics
...
Blocking with a melee will grant knockdown protection against obstacles, allowing for smoother flight. Alternatively, performing a slide/dash attack will allow passage through obstacles without slowing down.
**Trivia:**
The Knux were first revealed in Devstream 53. At that time, the player would wield one Knux like a club with its palm open, although it is possible that this was just a placeholder animation.
Pressing the block button once will make the Knux spin its fists.
p8mfctUXOP8
**Type:** Arch-Melee | **Mastery Req:** 7 | **Riven Disposition:** 1

### Normal Attack
**Damage:** impact: 400.5, slash: 22.25, puncture: 22.25
Crit Chance: 13.00% | Crit Multiplier: 2x | Status Chance: 30.00% | Fire Rate: 1
...
| Detonite Injector | 5 | — |
| Forma | 1 | — |
| Furax | 1 | Conclave, Typhoon (100.00%) |
| Gallium | 10 | — |
...
The Onorix is an Archmelee heavy axe.
Characteristics
This weapon deals primarily Slash damage.
Advantages:
High Slash and good Impact damage – effective against health and shields.
...
The Agkuza hook-sword, Onorix axe, and Rathbone hammer all share an attack combo, making their gameplay extremely similar. Of them, the Onorix has the lowest base DPS, while the Rathbone has the highest base DPS, in line with their mastery ranks.
zEf3J8e29bM
**Type:** Arch-Melee | **Mastery Req:** 1 | **Riven Disposition:** 1

### Normal Attack
**Damage:** impact: 123.6, slash: 206, puncture: 82.4
Crit Chance: 15.00% | Crit Multiplier: 1.3x | Status Chance: 5.00% | Fire Rate: 1

### Crafting
| Component | Count | Drops |
|---|---|---|
| Blade | 2 | New Loka, Bountiful (100.00%) |
| Blueprint | 1 | — |
| Handle | 1 | The Perrin Sequence, Senior Associate (100.00%) |
| Neurodes | 3 | — |
...
Weapons
A rare object of beauty, this Archwing sword has been sheathed in prisma crystal and baptized in the void's energy.
The Prisma Veritux is the Prisma variant of the Veritux Archmelee sword, sporting higher critical chance, critical multiplier, status chance, and attack speed but with a steep reduction to damage.
Characteristics
This weapon deals primarily Slash damage.
...
### Normal Attack
**Damage:** impact: 59.1, slash: 275.8, puncture: 59.1
...
Weapons
Using Archwing's jets for thrust, this massive hammer crushes anything in its path.
The Rathbone is a large Archmelee heavy Hammer.
}
|}
Characteristics
This weapon deals primarily Impact damage.
Advantages:
Second highest base damage of all Archmelees, behind Veritux.
...
The Agkuza hook-sword, Onorix axe, and Rathbone hammer all share an attack combo, making their gameplay extremely similar. Of them, the Onorix has the lowest base DPS, while the Rathbone has the highest base DPS, in line with their mastery ranks.
2-L6DwptxlM
**Type:** Arch-Melee | **Mastery Req:** 6 | **Riven Disposition:** 1

### Normal Attack
**Damage:** impact: 360, slash: 22.5, puncture: 67.5
Crit Chance: 20.00% | Crit Multiplier: 2x | Status Chance: 12.00% | Fire Rate: 0.917
...
| Circuits | 300 | — |
| Control Module | 1 | — |
| Handle | 1 | Red Veil, Honored (100.00%) |
| Head | 1 | New Loka, Bountiful (100.00%) |
...
Weapons
Weightless space turns this impossibly massive sword into an agile instrument of destruction.
The Veritux is a massive Archmelee telescopic sword with massive damage but slow attack speed.
Characteristics
This weapon deals primarily Slash damage.
Innate Vazarin polarity.
Possesses delay between combo looping, hindering attack speed.
...
**Type:** Arch-Melee | **Riven Disposition:** 1

### Normal Attack
**Damage:** impact: 70.5, slash: 329, puncture: 70.5
