# Quests
All quests available in Warframe with descriptions.
...
Lotus
The girl flees, discovering ruins of an ancient temple where three Warframes are kneeling: Excalibur, Mag, and Volt.
Lotus
The girl approaches Excalibur and offers a Lotus flower in front of him. The scene cuts to the past, showing Excalibur petting his Kubrow as they watch a Bolkor dropship land in a Grineer camp. It then shows Excalibur sliding and performing a Stealth Finisher using his Nikana on a guard; the other guard turns and spots him, but is then attacked by the Kubrow. In the camp, the Bolkor is unloading supplies, and Excalibur drops in the middle and attacks with his Skana and Kunai. This does not go unnoticed by the rest of the camp, and Excalibur and his Kubrow fight their way through. Excalibur runs along the cliff wall and wields his Exalted Blade in mid-air, slamming down into the middle of the field and wiping out his enemies. His Kubrow approaches, dropping one of his Kunai next to him.
**Type:** Key

### Drop Sources
- Duviri/Endless: Tier 1 (Normal) — Legendary (0.67%)
- Duviri/Endless: Tier 3 (Normal) — Legendary (0.67%)
- Eidolon Gantulyst (Capture) — Uncommon (14.63%)
- Eidolon Gantulyst — Uncommon (18.25%)
- The Descendia: Infernum 20 Triple Arcane Rewards — Rare (3.70%)
- Duviri/Endless: Tier 9 (Normal) — Rare (4.00%)
- Veil Proxima/Erato (Skirmish), Rotation C — Rare (5.63%)
- Neptune/Mammon's Prospect (Skirmish), Rotation C — Rare (6.90%)
...
### Wiki
**Notes:**
Host must have Mutalist Alad V Assassinate Key in inventory to access mission. Only host's key will be consumed.
**Type:** Key
...
### Wiki
The Hex can refer to:
The Hex (Quest), a mainline quest that serves as an introduction to the year of 1999, Höllvania, and Protoframes.
The Hex (Syndicate), a syndicate formed by the Protoframes.
**Type:** Key
...
### Wiki
In-game description
The Old Peace is a main Quest, released in Update 41. In an attempt to track Albrecht Entrati, the Operator dives into their long forgotten memories of the Tau System.
Synopsis
...
The Operator is deployed to fight the Anarchs and later assists one of the Orokin Seven, revealed to be Ballas. After the Operator and Adis graduate from Tauron Academy, they receive an Ayatan from Margulis which contains kill-codes to eradicate the Anarch bases. However, the duo discover too late that Ballas also altered the kill-codes to terraform and destroy the Xenoflora, quickly leading to the dissolution of the peace treaty as the Orokin's forces turn on the Sentients without hesitation. An enraged Adis turns against the Operator and they battle. Adis is convinced too late and grievously wounds the Operator, whom he promptly revives - albeit at the last of his strength, leaving him to die in the Tenno's arms.
With the usage of Uriel, the Operator storms Tauron Academy in search of Ballas, only to find Margulis, who makes them forget about their time on Tau in order to protect them. The Lotus declares that Tau is within sight, but it will not be the same as they remember.
Walkthrough
...
## The Teacher
Corpus incursions into Grineer territory lead to showdown with a forgotten rival.
...
### Wiki
Quest Description
The Waverider is a solo-only side Quest, released in Update 30.5 (2021-07-06). The Tenno are tasked with unlocking a comic Graphica featuring Yareli, a Warframe that originated K-Driving and inspired the Ventkids.
Synopsis
Roky finds a comic Graphica called Waverider #1, featuring Yareli who inspired K-Driving, but is seriously injured trying to unlock it. Boon implores the Tenno to unlock it in her stead. As they unravel the Graphica's pages, which depict Yareli fighting against a slave-driver named Vulgran, Nef Anyo reveals that he brokered a deal with Roky to release the Ventkids debt to him in exchange for the completed Graphica for a buyer he has on Deimos.
The Tenno complete the Graphica, but Nef Anyo claims the buyer no longer wants the Graphica and is now useless to him. Boon discovered that the buyer was Grandmother who received the completed Graphica from the Ventkids in exchange for an elixir to heal Roky. She also bought out the vents where they live, removing their debts to Nef Anyo. Grandmother reveals to the Tenno that a blueprint of Yareli was hidden inside the Waverider #1 Graphica.
Walkthrough
Missing iOS controls
This quest can be accessed directly from the Codex, after completing the Vox Solaris and being Mastery Rank 3.
View Roky's Inbox Message
After starting the quest, the player will receive another inbox message from Roky, informing them about Yareli, the original inspiration for K-Driving, and had found something. She urges them to meet her in Fortuna.
**Type:** Key
...
### Wiki
Quest Description
Veilbreaker is a solo-only side Quest, released in Update 32. Narmer has recovered as a Murex emerges near Deimos, but Grineer Lancer Kahl-175 breaks free from Narmer's control and continues to fight to free his brothers.
Synopsis
On a Murex above Deimos, Kahl-175 removes his Narmer Veil. His distress signal is picked up by Daughter, who lends her support in exchange for information on Narmer's new leader Pazuul. After freeing captives and escaping, Kahl sets up a base of operations at the Drifter's Camp. His campaign to free his brothers is only just beginning.
Walkthrough
The player must have completed The New War.
The quest opens to show Sentient forces and a Murex converging over Deimos. Aboard the Murex, Kahl-175 is revealed to have survived The New War as his Narmer Veil collapses to the ground, breathing heavily as he regains his composure. The Tenno then receives an inbox message from Daughter who received news from Nora Night that an individual named Pazuul is reviving Narmer. Wanting to know more about this new leader, she tracked a distress beacon on the Murex over Deimos broadcasting "NEED REINFORCEMENTS".
Investigate the Murex
Aboard the Murex, Daughter instructs the Tenno to locate and disable the Medusa Hub which is jamming the location of the distress beacon. She reveals that Mother forced the Entrati to lay low to keep the Heart of Deimos safeguarded during The New War. The hub is disabled by shooting 9 floating energy nodes in sequence which must be done in under a minute.
**Type:** Key
...
### Wiki
Vox Solaris can refer to:
Vox, Eudico's alternate ego as the leader of Solaris United.
The Vox Solaris Quest, an mainline quest that serves as an introduction to Fortuna and Orb Vallis.
The Vox Solaris Syndicate, a shadow organization related to The Quills.
**Type:** Key

### Drop Sources
- Vox Solaris, Agent — Common (100.00%)
- Vox Solaris, Hand — Common (100.00%)
- Vox Solaris, Instrument — Common (100.00%)
- Vox Solaris, Operative — Common (100.00%)
- Vox Solaris, Shadow — Common (100.00%)
