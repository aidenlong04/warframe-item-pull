# Gear Items
All gear wheel items including ciphers, specters, and consumables.
...
### Drop Sources
- Entrati (Son), Acquaintance — Common (100.00%)
...
### Drop Sources
- Solaris United (The Business), Neutral — Common (100.00%)
...
### Drop Sources
- Ostron (Master Teasonai), Offworlder — Common (100.00%)
...
### Drop Sources
- Entrati (Son), Neutral — Common (100.00%)
...
### Drop Sources
- Entrati (Son), Acquaintance — Common (100.00%)
- Entrati (Son), Associate — Common (100.00%)
- Entrati (Son), Neutral — Common (100.00%)
- Entrati (Son), Stranger — Common (100.00%)
- Entrati (Son), Stranger — Common (100.00%)
- Ostron (Master Teasonai), Neutral — Common (100.00%)
- Ostron (Master Teasonai), Offworlder — Common (100.00%)
- Ostron (Master Teasonai), Trusted — Common (100.00%)
- Ostron (Master Teasonai), Visitor — Common (100.00%)
...
6-12 Wyrm Residue, depending on squad size, (either Fass Residue or Vome Residue) are needed to activate the bait machine in the first stage of the Isolation Vault bounty. Existing Residue will despawn, and new Residue will respawn for the players to collect.
They can be traded at Father in exchange for Father Tokens in quantities of 6 to 12. Curiously, Father will never ask for Residue in Token bundles that reward two or fewer tokens.
**Type:** Fish Bait

### Drop Sources
- Entrati (Daughter), Associate — Common (100.00%)
- Deimos/Cambion Drift (Level 30 - 40 Cambion Drift Bounty), Rotation A — Rare (3.23%)
- Deimos/Cambion Drift (Level 30 - 40 Cambion Drift Bounty), Rotation A — Rare (4.11%)
- Deimos/Cambion Drift (Level 30 - 40 Cambion Drift Bounty), Rotation A — Rare (7.50%)
...
### Drop Sources
- Cephalon Simaris, Kinetic Siphon Trap x 10 — Common (100.00%)
...
### Drop Sources
- Ceres/Lex (Capture) — Legendary (0.34%)
- Earth/Mantle (Capture) — Legendary (0.34%)
- Eris/Cosis (Capture) — Legendary (0.34%)
- Eris/Isos (Capture) — Legendary (0.34%)
- Europa/Abaddon (Capture) — Legendary (0.34%)
- Europa/Beleth (Capture) — Legendary (0.34%)
- Europa/Cryotic Front (Capture) — Legendary (0.34%)
- Jupiter/Ananke (Capture) — Legendary (0.34%)
- Lua/Copernicus (Capture) — Legendary (0.34%)
- Mars/Ara (Capture) — Legendary (0.34%)
- Mars/Quirinus (Capture) — Legendary (0.34%)
- Mercury/Elion (Capture) — Legendary (0.34%)
- Neptune/Galatea (Capture) — Legendary (0.34%)
- Phobos/Limtoc (Capture) — Legendary (0.34%)
- Phobos/Skyresh (Capture) — Legendary (0.34%)
- Phobos/Todd (Capture) — Legendary (0.34%)
- Pluto/Corb (Capture) — Legendary (0.34%)
- Pluto/Hydra (Capture) — Legendary (0.34%)
- Saturn/Cassini (Capture) — Legendary (0.34%)
- Saturn/Phoebe (Capture) — Legendary (0.34%)
- ...and 11 more sources
...
### Drop Sources
- Entrati (Daughter), Neutral — Common (100.00%)
...
### Drop Sources
- Cephalon Simaris, Synthesis Scanner x 25 — Common (100.00%)
...
## Vome Residue
A gobbet of raw flesh, fallen from the wyrm Vome in her death spasm. Used to attract Chondricord and Duriod in Cambion Drift cave hotspots during Fass and Vome.
Location: Cambion Drift on Deimos while Fass is active
**Type:** Fish Bait

### Drop Sources
- Entrati (Daughter), Friend — Common (100.00%)
- Deimos/Cambion Drift (Level 30 - 40 Cambion Drift Bounty), Rotation B — Rare (3.23%)
- Deimos/Cambion Drift (Level 30 - 40 Cambion Drift Bounty), Rotation B — Rare (4.11%)
- Deimos/Cambion Drift (Level 30 - 40 Cambion Drift Bounty), Rotation B — Rare (7.50%)
...
### Drop Sources
- Axio Basilisk — Rare (0.83%)
- Orm Harpi — Rare (1.11%)
- Elite Axio Basilisk — Rare (1.39%)
- Gyre Flak — Uncommon (1.66%)
- Vorac Basilisk — Uncommon (1.66%)
- Elite Orm Harpi — Uncommon (1.85%)
- Elite Taro Basilisk — Uncommon (1.85%)
- Elite Vorac Basilisk — Uncommon (2.27%)
- Elite Gyre Flak — Uncommon (2.77%)
- Exo Taktis — Uncommon (3.32%)
- Saturn/Kasio's Rest (Caches) — Rare (4.03%)
- Saturn/Lupal Pass (Caches) — Rare (4.03%)
- Saturn/Mordo Cluster (Caches) — Rare (4.03%)
- Saturn/Nodo Gap (Caches) — Rare (4.03%)
- Saturn/Vand Cluster (Caches) — Rare (4.03%)
- Elite Exo Taktis — Common (5.55%)
- Mocking Whisper — Uncommon (6.25%)
- Scathing Whisper — Uncommon (6.25%)
- The Fragmented Suzerain — Uncommon (6.25%)
- Neptune/Arva Vector (Caches), Rotation A — Rare (8.33%)
- ...and 11 more sources
